...
if authentication_status:
    ...
    with st.expander("Talk with ChatGPT about the Royal Game of Ur."):
        ...
        def game_of_questions():
            ...
            st.write("""**Learning from the Chatbot:** Use the chatbot as a learning tool. Ask it questions about the history, rules, and significance of the Royal Game of Ur. Use the information provided by the chatbot to deepen your understanding of the game.\n\n**Asking the Right Questions:** Begin by exploring the chatbot's capabilities. Ask it questions about the Royal Game of Ur and observe how it responds. Try to understand how the phrasing and specificity of your questions affect the responses.\n\n\n\n**Fact-checking the AI**: Remember that AI can sometimes generate "hallucinations" or false information. After receiving a response from the chatbot, try verifying the information using the assignment sources. This will help you learn to distinguish between factual AI outputs and hallucinations.""")

            st.header("Rubric:")
            st.write("""Rubric:**Prompting and Querying** (30 points):\n
            ...
            Learning from the Chatbot (30 points):\n

            Effectively uses the chatbot as a learning tool, as demonstrated in the chat logs (15 points)\n\n
